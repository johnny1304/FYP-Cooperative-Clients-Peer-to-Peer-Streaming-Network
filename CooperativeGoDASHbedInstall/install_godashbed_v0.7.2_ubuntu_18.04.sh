...
wget https://www.dropbox.com/s/kd28ftyaa5cc17y/goDash.zip?dl=0
unzip goDash.zip?dl=0
rm -rf ./__MACOSX
cd goDash
...
# download goDASHbed
wget https://www.dropbox.com/s/0u3id84d8wah9pn/goDASHbed.zip?dl=0
unzip goDASHbed.zip?dl=0
rm -rf ./__MACOSX

#install MiniNAM
cd goDASHbed
git clone git://github.com/uccmisl/MiniNAM
sudo mv MiniNAM/MiniNAM.py ./
cd ..
cd ..
