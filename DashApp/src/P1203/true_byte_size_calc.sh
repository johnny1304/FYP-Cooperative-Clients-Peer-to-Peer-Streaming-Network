...
#	Copyright (c)   2018, Andrew Nash, Benjamin Provan-Bessell, MISL Summer of Code 2018
#                   2019, Andrew Nash, Jason Quinlan, MISL Summer of Code 2019
...
# this has been tested and validated on our UHD x264 dataset across all 5 segment durations (2sec to 10sec)
